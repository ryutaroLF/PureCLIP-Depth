...
from .dpt_depth2 import DPTDepthModel
from .midas_net import MidasNet
from .midas_net_custom2 import MidasNet_small
...
def load_model(
    ...
    Args:
        ...
        use_imagenet_pretrained (bool): whether to initialize backbone with ImageNet pretrained weights
